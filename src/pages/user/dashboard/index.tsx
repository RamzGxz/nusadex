...
import { CopyIcon,  Cloud, CreditCard, Github, Keyboard, LifeBuoy, LogOut, Mail, MessageSquare, Plus, PlusCircle, Settings, UserPlus, Users } from "lucide-react"
    ...
    return (
        <div>
            <Tabs defaultValue="Dashboard" className="w-full mt-10">
                <TabsList className="grid lg:w-72 grid-cols-2 mb-20">
