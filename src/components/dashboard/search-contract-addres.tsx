                            ...
                            <CommandGroup>
                                <CommandItem>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-zinc-400 text-sm break-all">0x6cf0fe125b4535baf10bb587c28613ff27 98c44a</p>
                                    </div>
                                    <CopyIcon />
                                </CommandItem>
                            </CommandGroup>
                            <CommandGroup>
                                <CommandItem>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-zinc-400 text-sm break-all">5Au3xnvoqw5xjUc2HiFd2jPsPSuM5CW4H Z8fiX55gJat</p>
                                    </div>
                                    <CopyIcon />
                                </CommandItem>
                            </CommandGroup>
