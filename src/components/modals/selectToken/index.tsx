...
const ModalSelectToken = ({ setMint, tokenData, mint }: props) => {
          ...
          <div className='w-full space-y-5'>
            ...
            <div className='space-y-3'>
              ...
              <div className='w-full grid grid-cols-5 lg:gap-3 gap-2'>
                <Button disabled={mint === 'So11111111111111111111111111111111111111112'} onClick={() => handleSetMint('So11111111111111111111111111111111111111112')} className='h-fit p-1 flex items-center gap-1 px-3 w-full' variant={'outline'}>
                  <img src="https://img-v1.raydium.io/icon/So11111111111111111111111111111111111111112.png" alt='' className='w-6 h-6 object-cover rounded-full' />
